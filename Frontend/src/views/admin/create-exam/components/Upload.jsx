...
const Upload = () => {
  return (
    <Card className="grid h-full w-[450px] grid-cols-1 gap-3 rounded-[20px] bg-white bg-clip-border p-3 font-dm shadow-3xl shadow-shadow-500 dark:!bg-navy-800 dark:shadow-none 2xl:grid-cols-1">
      <div className="col-span-5 h-full w-full rounded-xl bg-lightPrimary dark:!bg-navy-700 2xl:col-span-6">
        <button className="flex h-full w-full flex-col items-center justify-center rounded-xl border-[2px] border-dashed border-gray-200 py-3 dark:!border-navy-700 lg:pb-0">
          ...
          <h4 className="text-xl font-bold text-brand-500 dark:text-white">
            Upload Problem Statements File
          </h4>
      ...
      <div className="col-span-5 flex h-full w-full flex-col justify-center overflow-hidden rounded-xl bg-white pl-3 pb-4 dark:!bg-navy-800">
        ...
        <p className="leading-1 mt-2 text-base font-normal text-gray-600">
          Upload Problem Statement files that contains only 2 columns (Statement
          number, Description)
        </p>
        <button
          href=" "
